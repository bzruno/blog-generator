...
def render(categories: List[str], posts: List[Dict[str, str]], content: str = "", **kwargs) -> str:
    ...
    html = '<figure style="max-width:100%;margin:20px auto;text-align:center;font-family:Inter,system-ui,sans-serif;color:#a9b1d6;font-size:14px;">\n'
    html += '  <canvas id="lifeGrid" style="max-width:100%;height:auto;border-radius:6px;background:#16161e;"></canvas>\n'
    html += '  <figcaption style="margin-top:15px;font-family:Inter,system-ui,sans-serif;color:#a9b1d6;font-size:14px;line-height:1.6;">\n'
